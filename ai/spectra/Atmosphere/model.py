...
class SpectraAtmosphereNet(nn.Module):
    """
    Modelo de atmosfera da Spectra usando ResNet como backbone.

    A ResNet funciona como extrator visual pré-treinado.
    A cabeça final é própria da Spectra e faz classificação multilabel
    para labels de atmosfera.

    Exemplos de labels:
        day, night, dawn_dusk,
        bright, dark, low_light, backlit,
        clear_weather, cloudy, foggy, rainy, snowy,
        warm_light, cold_light
    ...
    def create_backbone(self, backbone_name, pretrained):
